...
COLORS = {"GREEN": "#00D271", "BLUE": "#46C2F5", "ORANGE": "#FF8000"}
...
def display_rating_graph(ratings: list):
    if not ratings:
    ...
    fig.update_layout(
        xaxis=dict(tickmode="array", tickvals=bins, title="Rating (0 to 5)"), bargap=0.1
    )
